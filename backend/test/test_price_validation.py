...
class TestPriceValidation:
    ...
    def test_negative_prices_become_zero(self):
        ...
        result = filter_product_list(self.SAMPLE_PRODUCT, "all", min_price=-10, max_price=-5)
    ...
    def test_backwards_prices_get_swapped(self):
        ...
        result = filter_product_list(self.SAMPLE_PRODUCT, "all", min_price=100, max_price=30)
    ...
    def test_normal_price_range_works(self):
        ...
        result = filter_product_list(self.SAMPLE_PRODUCT, "all", min_price=40, max_price=60)
        assert len(result) == 1
